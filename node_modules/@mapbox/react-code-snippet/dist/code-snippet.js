...
var _reactCopyButton = require('@mapbox/react-copy-button');

var _reactCopyButton2 = _interopRequireDefault(_reactCopyButton);
...
var CodeSnippet = function (_React$PureComponent) {
  _inherits(CodeSnippet, _React$PureComponent);
  ...
  function CodeSnippet() {
    ...
    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = CodeSnippet.__proto__ || Object.getPrototypeOf(CodeSnippet)).call.apply(_ref, [this].concat(args))), _this), _this.adjustPositions = (0, _debounce2.default)(function () {
      var _this2 = _this,
  ...
  _createClass(CodeSnippet, [{
    ...
    value: function render() {
      ...
      var currentChunk = [];
      var allChunks = [];
      var endCurrentChunk = function endCurrentChunk(_ref2) {
        var live = _ref2.live;
        ...
        if (codeChunk.live) {
          ...
          if (props.onCopy) {
            copyElements.push(_react2.default.createElement(
              ...
              _react2.default.createElement(_reactCopyButton2.default, { text: codeChunk.raw, onCopy: onCopyChunk })
            ));
          }
        }
      });
      ...
      if (props.copyRanges === undefined && props.onCopy) {
        copyAllButton = _react2.default.createElement(
          ...
          _react2.default.createElement(_reactCopyButton2.default, { text: props.code, onCopy: props.onCopy })
        );
      }
