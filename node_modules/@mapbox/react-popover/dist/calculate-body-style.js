...
function calculateBodyStyle(placement, alignment, options, context) {
  ...
  var style = (_style = {}, _defineProperty(_style, prefixedTransform, 'translate3d(' + leftOffset + 'px, ' + topOffset + 'px, 0)'), _defineProperty(_style, 'max-width', context.maxWidth + 'px'), _defineProperty(_style, 'max-height', context.maxHeight + 'px'), _style);
