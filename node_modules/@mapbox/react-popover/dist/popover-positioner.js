...
var PopoverPositioner = function (_React$PureComponent) {
  _inherits(PopoverPositioner, _React$PureComponent);
  ...
  function PopoverPositioner() {
    ...
    _classCallCheck(this, PopoverPositioner);

    for (var _len = arguments.length, args = Array(_len), _key = 0; _key < _len; _key++) {
      args[_key] = arguments[_key];
    }

    return _ret = (_temp = (_this = _possibleConstructorReturn(this, (_ref = PopoverPositioner.__proto__ || Object.getPrototypeOf(PopoverPositioner)).call.apply(_ref, [this].concat(args))), _this), _this.getScrollableParentElement = function () {
  ...
  _createClass(PopoverPositioner, [{
