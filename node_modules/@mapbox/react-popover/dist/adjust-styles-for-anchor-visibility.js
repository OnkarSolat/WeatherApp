...
function adjustStylesForAnchorVisibility(pointerStyle, bodyStyle, placement, options, context) {
  ...
  var onLeftOrRide = placement === _constants.PLACEMENT_LEFT || placement === _constants.PLACEMENT_RIGHT;

  if (placement === _constants.PLACEMENT_TOP && scrollableParentTop > context.anchorAbsoluteTop || placement === _constants.PLACEMENT_BOTTOM && scrollableParentBottom < context.anchorAbsoluteTop || !onLeftOrRide && scrollableParentBottom < context.anchorAbsoluteTop || !onLeftOrRide && scrollableParentTop > context.anchorAbsoluteBottom || onLeftOrRide && (
